import { School, Menu, Moon, Bell, LogOut } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-16 px-6 flex-1">
          ...
          <div className="md:flex items-center space-x-8 hidden">
            <div className="flex gap-5 items-center">
              <button className="relative text-gray-500 hover:text-black transition-colors hover:cursor-pointer">
                <Moon className="w-6 h-6 transition hover:-translate-y-1" />
              </button>
