  ...
  return (
    <div className="h-screen flex">
      <div className="fixed bg-emerald-500 inset-y-0 left-0 z-50 w-16 lg:w-44 dark:bg-gray-900 transform transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 text-white hidden md:block">
        <div className="flex items-center justify-center lg:justify-start h-16 px-4  border-l-2 border-gray-800 bg-gray-100 w-full">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main
          className=" text-black flex-1 overflow-auto bg-gradient-to-br dark:from-gray-900 dark:via-emerald-900 
            dark:to-gray-900 p-2 md:p-5 max-w-auto bg-gray-100"
          id="admin-outlet"
        >
          <div className="bg-white text-black dark:bg-white/10 dark:text-white h-full rounded-2xl p-1 md:p-5 max-w-auto md:ml-16 lg:ml-0 overflow-y-scroll shadow-lg">
            <Outlet />
          </div>
        </main>
      </div>
